...
public class Level05Activity extends AppCompatActivity {
    ...
    public void onClickButton(View view) {
        ...
        if (count == 5 && value == Collections.max(values)) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level05Activity.this);
            alertDialogBuilder
                    .setMessage("Level-05 is Completed \n" + "Score: " + (count + 20))
                    .setCancelable(false)
            ...
            Intent intent = new Intent(getApplicationContext(), Level05Activity.class);
            startActivity(intent);
            finish();
            count++;
            score.up();
