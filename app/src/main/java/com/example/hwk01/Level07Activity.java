...
public class Level07Activity extends AppCompatActivity {
    ...
    public void onClickButton(View view) {
        ...
        if (count == 5 && value == Collections.max(values)) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level07Activity.this);
            alertDialogBuilder
                    .setMessage("Level-07 is Completed \n" + "Score: " + (count + 30))
                    .setCancelable(false)
