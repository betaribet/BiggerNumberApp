...
public class Level06Activity extends AppCompatActivity {
    ...
    public void onClickButton(View view) {
        ...
        if (count == 5 && value == Collections.max(values)) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level06Activity.this);
            alertDialogBuilder
                    .setMessage("Level-06 is Completed \n" + "Score: " + (count + 25))
                    .setCancelable(false)
                    .setPositiveButton("NEXT LEVEL", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(getApplicationContext(), Level07Activity.class);
            ...
            Intent intent = new Intent(getApplicationContext(), Level06Activity.class);
            startActivity(intent);
            finish();
            count++;
            score.up();
