...
public class Level09Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level09);
        scoreLabel = (TextView) findViewById(R.id.scoreLabel);
        scoreLabel.setText("Score : " + score.getScore());
        createNewRandom(-100, 100, 6);
    }
    ...
    public void onClickButton(View view) {
        ...
        if (count == 5 && value == Collections.max(values)) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level09Activity.this);
            alertDialogBuilder
                    .setMessage("Level-09 is Completed \n" + "Score: " + (count + 40))
                    .setCancelable(false)
