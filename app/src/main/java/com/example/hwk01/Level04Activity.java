...
public class Level04Activity extends AppCompatActivity {
    ...
    public void onClickButton(View view) {
        ...
        if (count == 5 && value == Collections.max(values)) {
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level04Activity.this);
            alertDialogBuilder
                    .setMessage("Level-04 is Completed \n" + "Score: " + (count + 15))
                    .setCancelable(false)
